...
import { ObjectListDeleted } from '@/components/object';
  ...
  <div v-if="ready">
    ...
    >
      <font-awesome-icon
        ...
        class="mr-2 mt-2"
      />
      <span class="wrap-block w-11">{{ bucket.bucketName }}  - Deleted Files</span>
    </h2>
    <ObjectListDeleted :bucket-id="props.bucketId" />
  </div>
</template>
